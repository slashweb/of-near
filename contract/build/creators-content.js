...
let CreatorsContent = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = view(), _dec4 = view(), _dec5 = call({}), _dec6 = call({}), _dec(_class = (_class2 = class CreatorsContent {
  // Variable to save all the content of the users
  listOfContents = new Vector('list-of-contents');
  // Variable to save all the users inside the contract
  listOfUsers = new Vector('list-of-users');
  get_users() {
...
}, (_applyDecoratedDescriptor(_class2.prototype, "get_users", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_users"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "handle_exists", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "handle_exists"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_greeting", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "create_new_content", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "create_new_content"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "create_new_user", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "create_new_user"), _class2.prototype)), _class2)) || _class);
function create_new_user() {
  const _state = CreatorsContent._getState();
  if (!_state && CreatorsContent._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = CreatorsContent._create();
  if (_state) {
    CreatorsContent._reconstruct(_contract, _state);
  }
  const _args = CreatorsContent._getArgs();
  const _result = _contract.create_new_user(_args);
  CreatorsContent._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(CreatorsContent._serialize(_result, true));
}
function create_new_content() {
  ...
  const _args = CreatorsContent._getArgs();
  const _result = _contract.create_new_content(_args);
  CreatorsContent._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(CreatorsContent._serialize(_result, true));
}
...
function handle_exists() {
  ...
  const _args = CreatorsContent._getArgs();
  const _result = _contract.handle_exists(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(CreatorsContent._serialize(_result, true));
}
function get_users() {
  const _state = CreatorsContent._getState();
  ...
  const _args = CreatorsContent._getArgs();
  const _result = _contract.get_users(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(CreatorsContent._serialize(_result, true));
}

export { create_new_content, create_new_user, get_greeting, get_users, handle_exists };
//# sourceMappingURL=creators-content.js.map
